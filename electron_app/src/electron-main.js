...
app.on('ready', () => {
    ...
    if (appConfig['update_base_url']) {
        console.log(`Starting auto update with base URL: ${appConfig['update_base_url']}`);
        updater.start(appConfig['update_base_url']);
    } else {
        console.log('No update_base_url is defined: auto update is disabled');
    }

    const iconPath = `${__dirname}/../img/ogs.${process.platform === 'win32' ? 'ico' : 'png'}`;
    ...
    mainWindow.loadURL(appConfig['app_base_url']!=null?appConfig['app_base_url']:'https://online-go.com');
...
app.setAppUserModelId('com.squirrel.ogs-client.ogs');
